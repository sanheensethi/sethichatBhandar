...
{
$bill=$plates*50 + 20;
$bill1="( $plates Plates X ₹50 ) + <span style='color:red;'>Service Charge ₹20</span>&nbsp;=&nbsp;"."₹".$bill;
}
else
{
$plate=$plates-1;
$bill=(1*50+20)+($plate*50+$plate*5);
if($plate==1){ $ms="Plate";}
else{$ms="Plates";}
$bill1="(1 Plate X ₹50) + <span style='color:red;'>Servive Charge ₹20</span> +"."<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."( $plate $ms X ₹50 ) + <span style='color:red;'>Service Charge ₹5</span> ( $plate Plates X ₹5 )"."<br>"."<span style='color:red;font-size:30px;'>Total Bill&nbsp; = ₹".$bill."</span>";
}
}
date_default_timezone_set("Asia/Calcutta");
$t=time();
...
$data6="
				...
				<!--	<input type='radio' id='name' class= placeholder='Example : Manveer Sandhu' name='Sector_24'/>Yes
					...
					<label>City :</label>
					<input type='radio' id='name' name='city' value='Panchkula'/><span style='font-size:30px;'>Panchkula</span>
					<br><br>
...
$date=date("d-m-Y");
$fo=fopen("special/".$date."_special_order.txt","a+");
$fo1=fopen("specialhtml/".$date."_special_order.html","a+");
$plates=$_GET['plates'];
$fg=file_get_contents("soa.txt");
$newplates=$fg-$plates;
file_put_contents("soa.txt",$newplates);
...
Mobile Number : $m<br>
<br>
<span style='color:red;'>Thankyu for your order , We will deliver Before 8:45PM</span><br>
If you type anything wrong just call on 8360638695
...
<form action="" method="get">
   ...
   <br><span style='color:red;'><u><b>For Plate $i</b></u> </span><br>
    Red Sauce<input type='checkbox' name='ing[]' id='color' value='For Plate $i Red Sauce'>&nbsp&nbsp;Range : LOW <input type='checkbox' name='range[]' id='color' value='For Plate $i Red Sauce Range :: LOW'>&nbsp&nbsp;special <input type='checkbox' name='range[]' id='color' value='For Plate $i Red Sauce Range :: special'>&nbsp&nbsp;HIGH <input type='checkbox' name='range[]' id='color' value='For Plate $i Red Sauce Range :: HIGH'>&nbsp&nbsp;<br>
    Green Sauce<input type='checkbox' name='ing[]' id='color' value='For Plate $i Green Sauce'>&nbsp&nbsp;Range : LOW <input type='checkbox' name='range[]' id='color' value='For Plate $i Green Sauce Range :: LOW'>&nbsp&nbsp;special <input type='checkbox' name='range[]' id='color' value='For Plate $i Green Sauce Range :: special'>&nbsp&nbsp;HIGH <input type='checkbox' name='range[]' id='color' value='For Plate $i Green Sauce Range :: HIGH'>&nbsp&nbsp;<br>
    Curd<input type='checkbox' name='ing[]' id='color' value=' For Plate $i Curd'>&nbsp&nbsp;Range : LOW <input type='checkbox' name='range[]' id='color' value='For Plate $i Curd Range :: LOW'>&nbsp&nbsp;special <input type='checkbox' name='range[]' id='color' value='For Plate $i Curd Range :: special'>&nbsp&nbsp;HIGH <input type='checkbox' name='range[]' id='color' value='For Plate $i Curd Range :: HIGH'>&nbsp&nbsp;<br>
    Spicy<input type='checkbox' name='ing[]' id='color' value=' For Plate $i Spicy'>&nbsp&nbsp;Range : LOW <input type='checkbox' name='range[]' id='color' value='For Plate $i Spicy :: LOW'>&nbsp&nbsp;special <input type='checkbox' name='range[]' id='color' value='For Plate $i Spicy :: special'>&nbsp&nbsp;HIGH <input type='checkbox' name='range[]' id='color' value='For Plate $i Spicy :: HIGH'>&nbsp&nbsp;<br>
